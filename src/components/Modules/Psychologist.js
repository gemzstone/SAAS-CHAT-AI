...
const Psychologist = () => {
  ...
  const handleClick = () => {
    ...
    const prompt = "I want you to act a psychologist. i will provide you my thoughts. I want you to  give me scientific suggestions that will make me feel better. my first thought: ";
    setIsLoading(true);
      ...
      <section className="flex flex-col gap-4 p-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Briefly describe any concerns you'd like addressed"
            name="blog-input"
            id="input"
          ></input>
          <button
